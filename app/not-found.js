    ...
    return (
        <div className="w-screen h-screen bg-slate-950 flex flex-col items-center justify-center text-zinc-50 background">
            ...
            <div className="flex flex-col items-center gap-5">
                ...
                <Link href="/ticket" className="text-sm underline tracking-tighter text-orange-400 hover:text-orange-500"><Button className="bg-orange-600 hover:bg-orange-700">Back</Button></Link>
            </div>
        </div>
    )
}